...
const HERO_SLIDES = [
  { bg: "from-blue-600 to-indigo-700", title: "บ้านหมอยา", subtitle: "สินค้าของแท้ ได้มาตรฐาน ราคายุติธรรม" },
          ...
          <div className="relative max-w-6xl mx-auto px-6 py-20 md:py-28">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 max-w-2xl">
                ...
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">{s?.storeName || "บ้านหมอยา PharmaSIA"}</h1>
      ...
      <footer className="bg-white border-t border-gray-100 text-gray-500 py-10">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
          <div className="col-span-2 md:col-span-1">
            <h3 className="font-bold text-gray-800 mb-2">{s.storeNameTh || "บ้านหมอยา PharmaSIA"}</h3>
        ...
        <div className="border-t border-gray-50 mt-8 pt-6 text-center text-xs text-gray-300">&copy; 2026 {s.storeNameTh || "บ้านหมอยา PharmaSIA"}</div>
      </footer>
    </div>
  );
}
