...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (path.startsWith("/products/")) document.title = "รายละเอียดสินค้า | PharmaCare Ltd. Part.";
    else if (path.startsWith("/seller")) document.title = "ร้านค้า | PharmaCare Ltd. Part.";
    else document.title = (titles[path] || "") + (titles[path] ? " | PharmaCare Ltd. Part." : "PharmaCare Ltd. Part.");
  }, [location.pathname]);
